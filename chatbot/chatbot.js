...
function generateResponse(input) {
    ...
    if (input.toLowerCase().includes('whats your name')) {
        return `I am Selene.ai`;
    } else if (input.toLowerCase().includes('why are you here')) {
        return `I am here to assist you as your personal mental health chatbot.`;
    } else {
        // Default responses
        const responses = [
